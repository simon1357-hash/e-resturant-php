...
$commande = getCommandeNumero($user['id']);
?>
                        ...
                        <div class="card-profil h-100">
                            <div class="card-profil-body">
                                <h6 class="d-flex align-items-center mb-3">
                                    <i class="material-icons text-info mr-2">Mes commandes</i>
                                </h6>
                                    ...
                                    <div class="row">
                                        <?php foreach($commande as $commandes){?>
                                            <div class="col-md-12 my-1 list-commande-profil p-0">
                                                <a href="">
                                                    <p>C<?= $commandes['numero'] ?></p> <i class="fas fa-file-pdf"></i>
                                                </a>
                                            </div>
                                            <div class="col-md-12 my-1 list-commande-profil p-0">
                                                <a href="">
                                                    <p>Commande N°2454</p> <i class="fas fa-file-pdf"></i>
                                                </a>  
                                            </div>
                                        <?php } ?>
                                    </div>
