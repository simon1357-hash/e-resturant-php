                    ...
                    if(move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                        if ($fcode!="" && $name!="" && $photo!="" && $text!="" && $details!="" && $prix!="" && $newprix!="" && $category_id!="" && $subcategory_id!="") {
                            ...
                            if ($edata) {
                                ...
                                header('location: index.php?page=edit_all');
                                exit();
                            } else {
            ...
            <form acrion="" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $products['id'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="photo" name="photo" placeholder="Upload Photo" value ="<?php echo 'uploads/'.$products['photo']; ?>" >
