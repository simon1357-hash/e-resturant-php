    ...
    <?php
               ...
               ?>
                ...
                <div class="container bg-info">
                    <h3 class="text-danger"> ADD Menu chauds  </h3>
                        <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="subcategory_id">Menu Chaud subCategory</label>
                                        ...
                                        <a class="btn btn-secondary"  href="/lepetqwlepetit/admin/index.php?page=menu_chauds">close</a>
