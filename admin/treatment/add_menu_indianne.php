            ...
            if (isset($_POST['add'])) {
                 ...
                 // for the database
                   ...
                   if (empty($error)) {
                        if(move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                            ...
                            header('location: index.php?page=menu_indianne');
                            exit();
                            } else {
               ...
               ?>
                ...
                <div class="container bg-info">
                    <h3 class="text-danger"> ADD Menu </h3>
                        <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-secondary"  href="/lepetqwlepetit/admin/index.php?page=menu_indianne">close</a>
