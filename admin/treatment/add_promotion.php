    ...
    <?php
               if (isset($_POST['add'])) {
                   ...
                   if(move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                       $insert = $bdd->prepare("INSERT INTO istanbolmarket.products (name, photo , text, prix, newprix,  category_id, subcategory_id) VALUES ( ?, ?, ?, ?, ?, ?, ?)");
                       $insert->execute([$name, $photo, $text,  $prix, $newprix, $category_id, $subcategory_id]);
                       if($insert){
               ...
               ?>
                ...
                <div class="container bg-info">
                    <h3 class="text-danger"> ADD some New product </h3>
                        <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="float" class="form-control" id="exampleInputPassword1"  name="prix" placeholder="0.00" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="float" class="form-control"  name="newprix" placeholder="0.00" >
                                            ...
                                            $req=$bdd->query("SELECT * FROM istanbolmarket.categorys ");
                                            ?> 
                                            <div class="form-group">
